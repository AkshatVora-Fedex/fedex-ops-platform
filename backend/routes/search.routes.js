  ...
  try {
    ...
    res.json({
      ...
      data: {
        ...
        shipper: record.shipper || { companyName: 'Unknown' },
        recipient: record.recipient || { companyName: 'Unknown' },
        origin: record.origin || { locationCode: 'Unknown' },
        destination: record.destination || { locationCode: 'Unknown' },
        service: (typeof record.service === 'object' ? record.service?.type : record.service) || 'Priority',
